...
import { uploadImage } from '@/api/cropperApi'
...
export default {
  ...
  methods: {
      ...
      if (type === 'blob') {
        ...
        this.$refs.cropper.getCropBlob((data) => {
          ...
          const service= axios.create({
            baseURL: 'http://localhost:9999/gateway/kbs/kbs-file',
    ...
    readImg () {
      let box = this;
      // const img = new Image()
      // img.src = 'http://10.36.7.145/gateway/kbs/file/1607239625399_20191017120834765.jpg';
      ...
      var image = new Image();
      image.crossOrigin = '';
      image.src = 'http://10.36.7.145/gateway/kbs/file/1607239625399_20191017120834765.jpg';
